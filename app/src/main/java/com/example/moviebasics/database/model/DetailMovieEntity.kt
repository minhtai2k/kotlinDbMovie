...
data class DetailMovieEntity (
    ...
    @ColumnInfo(name = "belongsToCollection") val belongs_to_collection: belongs_to_collection?,
    ...
    @ColumnInfo(name = "productionCompanies") val production_companies: List<production_companies>,
    @ColumnInfo(name = "productionCountries") val production_countries: List<production_countries>,
    @ColumnInfo(name = "releaseDate") val release_date: String,
    @ColumnInfo(name = "revenue") val revenue: Int,
    @ColumnInfo(name = "runtime") val runtime: Int,
    @ColumnInfo(name = "spokenLanguages") val spoken_languages: List<spoken_languages>,
